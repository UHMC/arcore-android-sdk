...
//            mVirtualObjectShadow.setMaterialProperties(1.0f, 0.0f, 0.0f, 1.0f);
        ...
        try {
            virtualObjects.add(new ObjectRenderer());
            virtualObjects.get(1).createOnGlThread(this, "tabularasa.obj", "tabularasa.png");
            virtualObjects.get(1).setMaterialProperties(0.0f, 3.5f, 1.0f, 6.0f);
        } catch (IOException e) {
            Log.e(TAG, "Failed to read obj file");
        }
        try {
        ...
        try {
            virtualObjects.add(new ObjectRenderer());
            virtualObjects.get(3).createOnGlThread(this, "dresser.obj", "tabularasa.png");
            virtualObjects.get(3).setMaterialProperties(0.0f, 3.5f, 1.0f, 6.0f);
        } catch (IOException e) {
            Log.e(TAG, "Failed to read obj file");
        }
        try {
